...
A parameterized **Direct-Mapped Cache Controller** implemented in **SystemVerilog**. The project models the interaction between a CPU, cache, and main memory using a modular architecture and finite state machine (FSM). It is being developed incrementally with verification after each phase.
